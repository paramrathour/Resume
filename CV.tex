...
% personal data
\name{Param Rathour}{}
% \address{Department of Electrical Engineering, IIT Bombay}
...
\section{Education}
\vspace*{0.4em}
\headeducation{Indian Institute of Technology Bombay, Mumbai}\rhsmalle{Jul 2019 - Aug 2024}\\
{Bachelor of Technology in Electrical Engineering and with Minor in Computer Science}\\%\rhsmalle{CPI: 9.06/10}\\
{Master of Technology in Electrical Engineering with Specialization in Control and Computing}\rhsmalle{CPI: 9.06/10}\\
% {Dual Degree (B.Tech + M.Tech) in Electrical Engineering (Specialisation: Control and Computing)}\rhsmalle{CPI: 9.06/10}\\
% {Completed a {Minor} in {Computer Science \& Engineering}}\rhsmalle{CPI (CSE Courses): 9/10}\\%, and {Honours} in {Electrical Engineering}}% and \textbf{Data Science}
...
\begin{itemize}
	...
	% \item Reduced the board sizes of ciruits, improved their reliability and executed integrated testing of the electrical components
...
\begin{itemize}
	\item Conceptualised modelling problems for Pushdown Timed Automata (PDTA) from {Embedded Systems} and {WCET Benchmarks}%Worst-case execution time
...
\lhsmall{Guide: Prof. Vivek Borkar}\rhsmalle{EE736 $\mid$ Stochastic Optimisation}
\begin{itemize}
...
\end{itemize}
\head{Scenario Approach to Robust Optimisation}\rhsmall{May 2021 - Jul 2021}\\
\lhsmall{Guide: Prof. Debasish Chatterjee}\rhsmalle{Summer Undergraduate Research Program, IIT Bombay}
\begin{itemize}
	\item Worked on improving scenario approach to robust optimisation problems in the \textbf{moderate to high dimensional} regime
	\item Studied \textbf{concentration of measure} phenomenon for the analysis of randomised algorithms and the scenario approach
	\item Analysed various randomised algorithms like \textbf{MCMC, Propp-Wilson, simulated annealing} using Finite Markov Chains
\end{itemize}
...
\begin{itemize}
	...
	\item Evaluated both policies in \textbf{ChampSim} using 49 memory intensive traces from \textbf{SPEC} 2017 benchmarks and achieved an overall IPC speed-up over LRU of \textbf{5\% }for RLR and \textbf{1.2\%} for MAB with LRU, SHiP, SRRIP, DRRIP in its action space
\end{itemize}
...
\begin{itemize}
	...
	\item Implemented stabilisation of Rotary Inverted Pendulum using Swing-Up Control and \textbf{Linear-Quadratic Regulator} Control%Furuta pendulum%stabilisation
\end{itemize}
...
\end{itemize}
\head{Mini-8085 Microprocessor}\rhsmall{Jan 2022 - May 2022}\\
\lhsmall{Guide: Prof. Virendra Singh}\rhsmalle{EE739 $\mid$ Processor Design}
\begin{itemize}
	\item Designed a scaled down 8085 micro processor capable of handling \textbf{18} arithmetic, logical, branching instructions
	\item Devised level 2 hardware flowcharts, datapath organization, control words and decoding logic for provided ISA
\end{itemize}
...
\begin{description}
	...
	\item[Music Synthesiser] -- Designed an FSM to play 7 Indian music notes in a particular order with \textbf{Behavioral Style VHDL}\ \rhsmalle{EE214}%seven major notes of the Indian classical music
	...
	% \item[Dining Philosophers] -- Solved using both custom \textbf{semaphores} \& \textbf{condition variables} independently with \textbf{pthreads API} %to solve the synchronisation problem
...
\begin{itemize}
	\item Designed quantum circuits and implemented teleportation of information \& entangled pairs using qubits in \textbf{Qiskit} by IBM
...
\begin{itemize}
	\item Academically guided \textbf{50+} students and cleared their doubts through weekly doubt sessions, labs \& personal interaction
...
\begin{itemize}
	\item Academically guided \textbf{40+} students, cleared their doubts through tutorials and assisted the instructor in course evaluation
\end{itemize}
{\small\textbf{Control Systems $\mid$ EE302}}\rhsmalle{Spring 2024}
\begin{itemize}
	\item Academically guided \textbf{115+} students, assisted the instructor in preparing lessons, assignments and evaluated examinations
\end{itemize}
...
\begin{itemize}
	...
	\item Mentored \textbf{ten students} in exploring the subject and guided them through interesting resources of their respective topic%successfully
...
\textbf{Computer Science}& Operating Systems, Computer Networks, Data Structures, Design and Analysis of Algorithms,\newline Advanced Image Processing, Intelligent and Learning Agents, Formal Methods in Machine Learning\\%, Computer Programming and Utilisation\\%{Introduction to Machine Learning}
\textbf{Mathematics}& 
Calculus, Complex Analysis, Differential Equations, Linear Algebra, Large Sparse Matrix Computations,\newline Logic, Automata Theory, Discrete Structures, Number Theory, Cryptology, Error Correcting Codes,\newline Game Theory and Mechanism Design, Probability and Random Processes, Stochastic Optimisation\\%An Introduction to %Game Theory
%\textbf{Physics}& Quantum Physics and Application, Basics of Electricity and Magnetism                 \\
% \textbf{Coursera}& {Deep Learning Specialisation} (deeplearning.ai)\\% by deeplearning.ai 
...
\begin{itemize}
	\item Conducted an institute-wide \textbf{Computer Programming} session (TSC) attended by \textbf{100+} students for discussing doubts and previous year papers, organised by the Student Support Services\ \rhsmall{2022}%solving%
...
\begin{itemize}
	\item Secured 2\textsuperscript{nd} runner-up in the \textbf{Inter-IIT Scrabble} League representing the IIT Bombay contingent\ \rhsmall{2020}%11 June 2020
